...
public class CalendarImpl extends EObjectImpl implements Calendar {
	...
	protected EClass eStaticClass() {
		return DemoPackage.Literals.CALENDAR;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DemoPackage.CALENDAR__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<Meeting> getMeetings() {
		if (meetings == null) {
			meetings = new EObjectContainmentEList<Meeting>(Meeting.class, this, DemoPackage.CALENDAR__MEETINGS);
		}
		return meetings;
	}

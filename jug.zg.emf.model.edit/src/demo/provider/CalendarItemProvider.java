...
/**
 * This is the item provider adapter for a {@link demo.Calendar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalendarItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMeetingsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Calendar_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Calendar_description_feature", "_UI_Calendar_type"),
				 DemoPackage.Literals.CALENDAR__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Meetings feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMeetingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Calendar_meetings_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Calendar_meetings_feature", "_UI_Calendar_type"),
	...
	public String getText(Object object) {
		String label = ((Calendar)object).getDescription();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Calendar.class)) {
			case DemoPackage.CALENDAR__DESCRIPTION:

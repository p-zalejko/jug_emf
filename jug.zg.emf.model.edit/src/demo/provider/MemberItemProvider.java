...
/**
 * This is the item provider adapter for a {@link demo.Member} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemberItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DemoPackage.Literals.MEMBER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAddressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Member_address_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Member_address_feature", "_UI_Member_type"),
				 DemoPackage.Literals.MEMBER__ADDRESS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DemoPackage.Literals.MEMBER__ADDRESS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DemoPackage.Literals.MEMBER__ADDRESS,
				 DemoFactory.eINSTANCE.createAddress()));
	}
